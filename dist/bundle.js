...
const About_1 = __webpack_require__(106);
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store_1.store },
    React.createElement(react_router_dom_1.BrowserRouter, null,
        React.createElement("div", null,
            ...
            React.createElement(react_router_dom_1.Route, { exact: true, path: "/", component: TodoList_1.default }),
            React.createElement(react_router_dom_1.Route, { path: "/about", component: About_1.default })))), document.getElementById("example"));
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(2);
const todoListReducer_1 = __webpack_require__(54);
...
const todoApp = redux_1.combineReducers({
    todoList: todoListReducer_1.todoListReducers
});
...
const todoListReducers = (state = { todoList: initialTodos }, action) => {
    switch (action.type) {
        case "ADD_TODO":
            let _ret = [...state];
            _ret.push({
...
exports.todoListReducers = todoListReducers;
...
class TodoList extends React.Component {
    ...
    fillTodos() {
        let _ret = [];
        this.props.todoList.map((el) => _ret.push(React.createElement(Todo_1.default, { key: el.text, text: el.text, completed: el.completed })));
        return _ret;
    }
    render() {
        return (React.createElement("div", null,
            this.props.name,
            React.createElement("ul", null, this.fillTodos()),
            " ",
            React.createElement("input", { id: "todoTextInput", type: "text", placeholder: "...add a task here" }),
...
const mapTodoDispatchToProps = (dispatch) => {
    return redux_1.bindActionCreators({ completeTask: completeTask_1.completeTask }, dispatch);
};
exports.default = react_redux_1.connect(mapTodoStateToProps, mapTodoDispatchToProps)(Todo);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const withLinks_1 = __webpack_require__(62);
...
const withLinks = (WrappedComponent) => {
    return class ProxyProps extends React.Component {
        ...
        render() {
            return (React.createElement("div", null,
                React.createElement(react_router_dom_1.Link, { to: "/" }, " index "),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LocationUtils__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LocationUtils__ = __webpack_require__(66);
